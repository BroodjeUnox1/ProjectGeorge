...
<body>
    ...
    <div class="container" id="main">
        <div class="row">
            ...
            <form action="adminMenuInsertFood.php" method="POST" class="editForm mb-3 mt-3">
                <div class="container">
                    <form action="test2.php" method="POST" class="editForm mb-3 mt-3">
                        ...
                        <select name="vegitarian" class="form-select form-select-sm"
                        ...
                        <label for="exampleInputLijst" class="form-label mt-3">Category</label>
                        <select name="category" class="form-select" aria-label="Default select example">
                            <option selected>Open this select menu</option>
                            <?php
                                $category = $categoriesObj->displayDataCategoriesFoods();
                                foreach ($category as $category) {
                            ?>
                            <option name="category" value="<?php echo $category['id']?>"><?php echo $category['name']?>
                            </option>
                            <?php } ?>
                        </select>

                        <button type="submit" name="submit" class="btn mt-3 float-end" value="submit">Submit</button>
                        <a href="adminMenuLijstViewFood.php?catId=">
